            ...
            <div className="-mx-3 flex items-center sm:-mx-4">
              <div className="w-full px-3 sm:px-4 xl:w-1/2">
                <div className="py-3 sm:py-4">
                  <img src={img1} alt="Image" className="w-full rounded-2xl" />
                </div>
                <div className="py-3 sm:py-4">
                  <img src={img2} alt="Image" className="w-full rounded-2xl" />
                </div>
              </div>
              <div className="w-full px-3 sm:px-4 xl:w-1/2">
                <div className="relative z-10 my-4">
                  <img src={img3} alt="Image" className="w-full rounded-2xl" />
